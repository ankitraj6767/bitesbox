...
export function RiderDocumentsButton({
  ...
  const label =
    totalCount === 0
      ? "No documents"
      : `${totalCount} submitted · ${approvedCount} approved`;
            ...
            <div className="space-y-4">
              {data.ready_to_activate && data.onboarding_status !== "ACTIVE" ? (
                <InlineNotice tone="positive">
                  Every required document is approved. {riderName} can be
                  activated from the Approve action.
                </InlineNotice>
              ...
              <p className="flex items-start gap-1.5 text-[11.5px] text-ink-muted">
                ...
                These are identity documents in a private bucket. Every view is
                a signed link that expires in two minutes, and every decision is
